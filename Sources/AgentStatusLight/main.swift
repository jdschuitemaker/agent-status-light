...
@MainActor final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let agentApps: Set<String> = ["com.apple.Terminal", "com.googlecode.iterm2", "com.microsoft.VSCode", "com.microsoft.VSCodeInsiders", "com.openai.chat", "com.todesktop.230313mzl4w4u92", "dev.warp.Warp-Stable", "io.alacritty", "net.kovidgoyal.kitty", "com.github.wez.wezterm", "com.mitchellh.ghostty", "com.termius.Termius"]
    private let agentAppNames: Set<String> = ["Terminal", "iTerm2", "Visual Studio Code", "Code", "Cursor", "Warp", "Ghostty", "Alacritty", "kitty", "WezTerm", "ChatGPT", "Codex", "Termius"]
    private func lookingAtAgent() -> Bool { guard pref("onlyAlertWhenAway"), let front = NSWorkspace.shared.frontmostApplication else { return false }; return agentApps.contains(front.bundleIdentifier ?? "") || agentAppNames.contains(front.localizedName ?? "") }
    ...
    @objc private func toggleAwayOnly() { UserDefaults.standard.set(!pref("onlyAlertWhenAway"), forKey: "onlyAlertWhenAway") }
